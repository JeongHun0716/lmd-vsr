...
from src.unit_dataset import UTUTDataset
...
@register_task("lmdecoder_pretraining", dataclass=AVHubertPretrainingConfig)
class LMDecoderPretrainingTask(AVHubertPretrainingTask):
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        self.datasets[split] = UTUTDataset(
            manifest,
